        ...
        Item {
            ...
            Item {
                ...
                SequentialAnimation {
                    ...
                    // 1. Fast Pop in & expanding shockwaves (Faster ~1.15x)
                    ParallelAnimation {
                        NumberAnimation { target: introLockOrb; property: "scale"; from: 0.0; to: 1.0; duration: 150; easing.type: Easing.OutBack }
                        NumberAnimation { target: introLockOrb; property: "opacity"; from: 0.0; to: 1.0; duration: 110 }
                        
                        NumberAnimation { target: ring1; property: "scale"; from: 0.8; to: 1.25; duration: 260; easing.type: Easing.OutQuad }
                        NumberAnimation { target: ring1; property: "opacity"; from: 0.8; to: 0.0; duration: 260; easing.type: Easing.OutQuad }
                        
                        NumberAnimation { target: ring2; property: "scale"; from: 0.8; to: 1.4; duration: 300; easing.type: Easing.OutQuad }
                        NumberAnimation { target: ring2; property: "opacity"; from: 0.5; to: 0.0; duration: 300; easing.type: Easing.OutQuad }

                        NumberAnimation { target: ring3; property: "scale"; from: 0.5; to: 1.5; duration: 350; easing.type: Easing.OutCubic }
                        NumberAnimation { target: ring3; property: "opacity"; from: 0.4; to: 0.0; duration: 350; easing.type: Easing.OutCubic }
                    }
                    
                    // 2. Faster Spin, Pulse Morph & Overshoot easing
                    ParallelAnimation {
                        NumberAnimation { target: introLockOrb; property: "rotation"; from: 0; to: 360; duration: 260; easing.type: Easing.InOutBack } 
                        
                        SequentialAnimation {
                            NumberAnimation { target: introLockOrb; property: "scale"; to: 1.15; duration: 130; easing.type: Easing.OutQuad }
                            NumberAnimation { target: introLockOrb; property: "scale"; to: 1.0; duration: 130; easing.type: Easing.InQuad }
                        }

                        SequentialAnimation {
                            PauseAnimation { duration: 110 }
                            ParallelAnimation {
                                NumberAnimation { target: introIconUnlocked; property: "opacity"; to: 0.0; duration: 65 }
                                NumberAnimation { target: introIconLocked; property: "opacity"; to: 1.0; duration: 65 }
                            }
                        }
                    }
                    ...
                    // 4. Reveal Desktop Sequentially 
                    SequentialAnimation {
                        ParallelAnimation {
                            NumberAnimation { target: introLockOrb; property: "scale"; to: 2.2; duration: 215; easing.type: Easing.InBack }
                            NumberAnimation { target: introOverlay; property: "opacity"; to: 0.0; duration: 215; easing.type: Easing.InCubic }
                        }
                        
                        // 5. Clock and desktop ONLY fade in AFTER the lock is completely gone
                        NumberAnimation { target: screenRoot; property: "introState"; from: 0.0; to: 1.0; duration: 260; easing.type: Easing.OutQuart }
                    }

                    // Complete Lock sequence and release control back to user
